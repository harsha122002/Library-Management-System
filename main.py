...
class Management:
    def __init__(self, root):
        ...
        self.issue_book = Button(self.frame_2, text='Issue Book', font=(cs.font_1, 12), bd=2,
                                 command=self.GetData_for_IssueBook, cursor="hand2", bg=cs.color_7,
                                 fg=cs.color_3).place(x=50, y=100, width=100)
        self.return_book = Button(self.frame_2, text='Return Book', font=(cs.font_1, 12), bd=2, command=self.ReturnBook,
                                  cursor="hand2", bg=cs.color_6, fg=cs.color_3).place(x=50, y=160, width=100)
        self.all_book = Button(self.frame_2, text='All Books', font=(cs.font_1, 12), bd=2, command=self.ShowBooks,
                               cursor="hand2", bg=cs.color_2, fg=cs.color_3).place(x=50, y=220, width=100)

        self.search_book = Button(self.frame_2, text='Search Book', font=(cs.font_1, 12), bd=2,
                                  command=self.GetBookNametoSearch, cursor="hand2", bg=cs.color_2, fg=cs.color_3).place(
            x=180, y=40, width=100)
        self.all_borrow_records = Button(self.frame_2, text='Book Holders', font=(cs.font_1, 12), bd=2,
                                         command=self.AllBorrowRecords, cursor="hand2", bg=cs.color_2,
                                         fg=cs.color_3).place(x=180, y=100, width=100)
        self.clear = Button(self.frame_2, text='Clear Screen', font=(cs.font_1, 12), bd=2, command=self.ClearScreen,
                            cursor="hand2", bg=cs.color_2, fg=cs.color_3).place(x=180, y=160, width=100)
        self.exit = Button(self.frame_2, text='Exit', font=(cs.font_1, 12), bd=2, command=self.Exit, cursor="hand2",
                           bg=cs.color_2, fg=cs.color_3).place(x=180, y=220, width=100)

    # Function 1: It gets call from 'Function 15' when the user clicks on a record
    def OnSelectedforReturn(self, a):
        self.dlt_record = Button(self.frame_3, text='Delete', font=(cs.font_1, 12), bd=2, command=self.ReturningBook,
                                 cursor="hand2", bg=cs.color_2, fg=cs.color_3).place(x=50, y=0, width=100)
        self.borrow_again = Button(self.frame_3, text='Issue Again', font=(cs.font_1, 12), bd=2,
                                   command=self.IssueAgain, cursor="hand2", bg=cs.color_2, fg=cs.color_3).place(x=180,
                                                                                                                y=0,
                                                                                                                width=100)
    ...
    def OnSelectedforBorrowRecords(self, a):
        self.dlt_record = Button(self.frame_3, text='Delete', font=(cs.font_1, 12), bd=2, command=self.ReturningBook,
                                 cursor="hand2", bg=cs.color_2, fg=cs.color_3).place(x=50, y=0, width=100)
        self.update_record = Button(self.frame_3, text='Update', font=(cs.font_1, 12), bd=2, command=self.IssueAgain,
                                    cursor="hand2", bg=cs.color_2, fg=cs.color_3).place(x=180, y=0, width=100)
    ...
    def IssueAgain(self):
        ...
        book_name = Label(self.frame_1, text="Book Name", font=(cs.font_2, 15, "bold"), bg=cs.color_1).place(x=400,
                                                                                                             y=30)
        bookname = Label(self.frame_1, text=row[1], font=(cs.font_1, 10))
        bookname.place(x=400, y=60, width=200)

        student_roll = Label(self.frame_1, text="Student Roll", font=(cs.font_2, 15, "bold"), bg=cs.color_1).place(
            x=130, y=100)
        sturoll = Label(self.frame_1, text=row[2], font=(cs.font_1, 10))
        sturoll.place(x=130, y=130, width=200)

        student_name = Label(self.frame_1, text="Student Name", font=(cs.font_2, 15, "bold"), bg=cs.color_1).place(
            x=400, y=100)
        ...
        issue_date = Label(self.frame_1, text="Issue Date", font=(cs.font_2, 15, "bold"), bg=cs.color_1).place(x=130,
                                                                                                               y=240)
        issuedate = Label(self.frame_1, text=row[6], font=(cs.font_1, 10))
        issuedate.place(x=130, y=270, width=200)

        return_date = Label(self.frame_1, text="Return Date", font=(cs.font_2, 15, "bold"), bg=cs.color_1).place(x=400,
                                                                                                                 y=240)
        ...
        self.submit_bt = Button(self.frame_1, text='Submit', font=(cs.font_1, 12), bd=2,
                                command=partial(self.BorrowBookAgain, row), cursor="hand2", bg=cs.color_2,
                                fg=cs.color_3).place(x=300, y=320, width=100)
    ...
    def GetData_for_IssueBook(self):
        ...
        self.submit_bt_1 = Button(self.frame_1, text='Submit', font=(cs.font_1, 12), bd=2,
                                  command=self.Submit_borrow_data, cursor="hand2", bg=cs.color_2, fg=cs.color_3).place(
    ...
    def GetBookNametoSearch(self):
        self.ClearScreen()
        search_book = Label(self.frame_1, text="Search Book", font=(cs.font_1, 30, "bold"), bg=cs.color_4).place(x=250,
                                                                                                                 y=40)
        book_name = Label(self.frame_1, text="Enter the Book Name", font=(cs.font_2, 15, "bold"), bg=cs.color_1).place(
            x=220, y=140)
        self.book_entry = Entry(self.frame_1, bg=cs.color_4, fg=cs.color_3)
        self.book_entry.place(x=220, y=175, width=300)

        self.search_bt = Button(self.frame_1, text='Search', font=(cs.font_1, 12), bd=2, command=self.SearchBook,
                                cursor="hand2", bg=cs.color_2, fg=cs.color_3).place(x=310, y=215, width=100)
